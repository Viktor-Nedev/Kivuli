    ...
    <section className="border-t border-shade-700 py-10 sm:py-12">
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <div className="lift-on-hover flex items-center gap-5 rounded-lg py-2">
          ...
          <div>
            <p className="text-xs text-shade-200"><Term term="wbgt">WBGT</Term>, measured</p>
        ...
        <div className="lift-on-hover flex items-center gap-5 rounded-lg py-2">
          ...
          <div>
            <p className="text-xs text-shade-200">Cattle heat index (THI)</p>
            <p className="mt-1 text-sm text-shade-200">{thi.instruction}</p>
          </div>
        </div>
      </div>

      <p className="mt-5 max-w-2xl text-xs leading-relaxed text-shade-200">
