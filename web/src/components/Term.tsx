...
export function Term({ term, children }: { term: TermKey; children?: ReactNode }) {
  ...
  return (
    <span className="group relative inline-block">
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-0 z-20 mb-2 hidden w-64 glass-strong rounded-2xl p-3 text-left text-xs font-normal leading-relaxed text-shade-200 shadow-lg group-hover:block group-focus-within:block group-active:block"
      >
